...
class ApplyDetectorScanEffCorr(PythonAlgorithm):
    ...
    def PyInit(self):
        ...
        self.declareProperty(
            WorkspaceProperty("DetectorEfficiencyWorkspace",
                              "",
    ...
    def PyExec(self):
        ...
        to_multiply = CreateWorkspace(DataY=np.repeat(efficiencies, n_time_indexes),
                                      DataE=np.repeat(errors, n_time_indexes),
                                      DataX=np.zeros(n_hist),
                                      NSpec=n_hist,
                                      StoreInADS=False)
        output = Multiply(LHSWorkspace=input_ws,
