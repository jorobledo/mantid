...
class ConjoinSpectra(PythonAlgorithm):
    ...
    def PyInit(self):
        ...
        self.declareProperty("LabelUsing",
                             "",
                             doc="The name of a log value used to label the resulting spectra. " +
                             "Default: The source workspace name")
        labelValueOptions = ["Mean", "Median", "Maximum", "Minimum", "First Value"]
        self.declareProperty("LabelValue",
                             "Mean",
    ...
    def GetLogValue(self, ws, labelUsing, labelValue):
        ...
        try:
            ...
            logger.information("Could not find log " + labelUsing + " in workspace " + str(ws) +
                               " using workspace label instead.")
        return labelString
