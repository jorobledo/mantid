...
class IndirectFlatPlateAbsorption(DataProcessorAlgorithm):
    ...
    def PyInit(self):
        ...
        # General
        self.declareProperty(name='ElementSize',
                             defaultValue=0.1,
                             validator=FloatBoundedValidator(0.0),
    ...
    def PyExec(self):
        ...
        ConvertUnits(InputWorkspace=self._sample_ws,
        ...
        sample_logs = [('sample_shape', 'flatplate'), ('sample_filename', self._sample_ws),
                       ('sample_height', self._sample_height), ('sample_width', self._sample_width),
                       ('sample_thickness', self._sample_thickness), ('element_size', self._element_size)]
