...
class ReduceLET_OneRep(ReductionWrapper):
    ...
    def reduce(self, input_file=None, output_directory=None):
        ...
        LoadEventNexus(Filename='LET00006278.nxs',
...
class ReduceLET_MultiRep2015(ReductionWrapper):
    ...
    def def_main_properties(self):
        ...
        ebin = [-4, 0.002,
                0.8]  #binning of the energy for the spe file. The numbers are as a fraction of ei [from ,step, to ]
    ...
    def def_advanced_properties(self):
        ...
        prop[
            'hardmaskOnly'] = 'LET_hard.msk'  # diag does not work well on LET. At present only use a hard mask RIB has created
