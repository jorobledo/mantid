...
class WishMasking(systemtesting.MantidSystemTest):
    ...
    def runTest(self):
        ...
        self.assertTrue(mask_ws.spectrumInfo().isMasked(masking_edge) == mask_ws.spectrumInfo().isMasked(masking_edge +
                                                                                                         1))
        ...
        try:
            ...
            MergeCalFiles(UpdateFile=update_cal_file_path,
                          MasterFile=master_cal_file_path,
                          OutputFile=merged_cal_file_name,
