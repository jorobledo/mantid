...
#
# The function creates an imported target prefixed in a similar manner to the
# Qt4/Qt5 targets.
function(find_qscintilla qt_version)
  if(qt_version EQUAL 4)
    ...
    set(_qsci_lib_names qscintilla2 libqscintilla2 qscintilla2_qt4
  ...
  if(${_include_var} AND ${_library_var})
    if(NOT QScintillaQt${qt_version}_FIND_QUIETLY)
      message(
        STATUS
          "Found QScintilla2 linked against Qt${qt_version}: ${${_library_var}}"
      )
    endif()
    ...
    set_target_properties(
      ${_target_name}
      PROPERTIES INTERFACE_INCLUDE_DIRECTORIES ${${_include_var}}
    ...
    if(${_library_var_debug})
      ...
      set_target_properties(
        ${_target_name} PROPERTIES ${_lib_import_var}_DEBUG
                                   "${${_library_var_debug}}"
      )
    endif()
  else()
    if(QScintillaQt${qt_version}_FIND_REQUIRED)
      message(
        FATAL_ERROR "Failed to find Qscintilla linked against Qt${qt_version}"
      )
    elseif(QScintillaQt${qt_version}_FIND_QUIETLY)
      message(
        WARNING "Failed to find Qscintilla linked against Qt${qt_version}"
      )
    endif()
  endif()
