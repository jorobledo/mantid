...
draw_if_interactive.__signature__ = inspect.signature(draw_if_interactive_impl)
show = QAppThreadCall(show_impl)
show.__signature__ = inspect.signature(show_impl)
# These are wrapped by figuremanager
new_figure_manager = new_figure_manager_impl
new_figure_manager.__signature__ = inspect.signature(new_figure_manager_impl)
