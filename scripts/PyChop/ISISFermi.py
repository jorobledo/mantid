...
class ISISFermi:
    ...
    __chopperParameters = {
        ...
        'MARI': {
            'A': {
                'par': [0.760, 0.550, 49., 1300., 0., 0.],
                'fluxcorr': 3.,
                'title': 'MARI A (500meV)'
            },
            'B': {
                'par': [1.140, 0.550, 49., 820., 0., 0.],
                'fluxcorr': 3.,
                'title': 'MARI B (200meV)'
            },
            'C': {
                'par': [1.520, 0.550, 49., 580., 0., 0.],
                'fluxcorr': 3.,
                'title': 'MARI B (100meV)'
            },
            'G': {
                'par': [0.380, 0.020, 10., 800., 0., 0.],
                'fluxcorr': 3.2,
                'title': 'MARI G (Gadolinium)'
            },
            'R': {
                'par': [1.143, 0.550, 49., 1300., 0., 0.],
                'fluxcorr': 3.,
                'title': 'MARI R (500meV)'
            },
            'S': {
                'par': [2.280, 0.550, 49., 1300., 0., 0.],
                'fluxcorr': 2.7,
                'title': 'MARI S (Sloppy)'
            }
        },
        'MAPS': {
            'A': {
                'par': [1.087, 0.534, 49., 1300., 0., 0.],
                'fluxcorr': 3.,
                'title': 'MAPS A (500meV)'
            },
            'B': {
                'par': [1.812, 0.534, 49., 920., 0., 0.],
                'fluxcorr': 3.,
                'title': 'MAPS B (200meV)'
            },
            'S': {
                'par': [2.899, 0.534, 49., 1300., 0., 0.],
                'fluxcorr': 2.5,
                'title': 'MAPS S (Sloppy)'
            }
        },
        'MERLIN': {
            'S': {
                'par': [2.28, 0.55, 49., 1300., 0., 0.],
                'fluxcorr': 3.,
                'title': 'HET S (Sloppy)'
            },
            'G': {
                'par': [0.2, 0.02, 5., 1.e6, 0., 0.],
                'fluxcorr': 3.,
                'title': 'MERLIN G (Gadolinium)'
            }
        }
    }
    ...
    __Moderators = {
        'MAPS': {
            ...
            'mod_scale_par': [1., 0., 0., 150., 0.01, 70.],
            'theta': 32.
        },
        'MARI': {
            'imod': 2,
    ...
    def getModWidth(self, Ei_in=None):
        ...
        if self.__Moderators[self.instname]['imod'] == 0:
            ...
            if self.__Moderators[self.instname]['mod_scale_fn']:
                d0 = self.__Moderators[self.instname]['mod_scale_fn'](Ei,
                                                                      self.__Moderators[self.instname]['mod_scale_par'])
    ...
    def getResolution(self, Etrans=None, Ei_in=None, frequency=None):
        ...
        for ie, en in enumerate(Etrans):
            van.append(
                np.real(convert * 8.747832e-4 * np.sqrt(
                    (Ei - en)**3) * (np.sqrt(v_van[ie] + (tbin**2 / 12.00)) * 1.0e6) / x2))
        if frequency:
            self.setFrequency(oldfreq)
        return np.array(van)
    ...
    def flux_store(self):
        ...
        """
        lam = [
            1.5000e-01, 2.5000e-01, 3.5000e-01, 4.5000e-01, 5.5000e-01, 6.5000e-01, 7.5000e-01, 8.5000e-01, 9.5000e-01,
            1.0500e+00, 1.1500e+00, 1.2500e+00, 1.3500e+00, 1.4500e+00, 1.5500e+00, 1.6500e+00, 1.7500e+00, 1.8500e+00,
            1.9500e+00, 2.0500e+00, 2.1500e+00, 2.2500e+00, 2.3500e+00, 2.4500e+00, 2.5500e+00, 2.6500e+00, 2.7500e+00,
            2.8500e+00, 2.9500e+00, 3.0500e+00, 3.1500e+00, 3.2500e+00, 3.3500e+00, 3.4500e+00, 3.5500e+00, 3.6500e+00,
            3.7500e+00, 3.8500e+00, 3.9500e+00, 4.0500e+00, 4.1500e+00, 4.2500e+00, 4.3500e+00, 4.4500e+00, 4.5500e+00,
            4.6500e+00, 4.7500e+00, 4.8500e+00, 4.9500e+00, 5.0500e+00, 5.1500e+00, 5.2500e+00, 5.3500e+00, 5.4500e+00,
            5.5500e+00, 5.6500e+00, 5.7500e+00, 5.8500e+00, 5.9500e+00, 6.0500e+00, 6.1500e+00, 6.2500e+00, 6.3500e+00,
            6.4500e+00, 6.5500e+00, 6.6500e+00, 6.7500e+00, 6.8500e+00, 6.9500e+00, 7.0500e+00, 7.1500e+00, 7.2500e+00,
            7.3500e+00, 7.4500e+00, 7.5500e+00, 7.6500e+00, 7.7500e+00, 7.8500e+00, 7.9500e+00, 8.0500e+00, 8.1500e+00,
            8.2500e+00, 8.3500e+00, 8.4500e+00, 8.5500e+00, 8.6500e+00, 8.7500e+00, 8.8500e+00, 8.9500e+00, 9.0500e+00,
            9.1500e+00, 9.2500e+00, 9.3500e+00, 9.4500e+00, 9.5500e+00, 9.6500e+00, 9.7500e+00, 9.8500e+00, 9.9500e+00,
            1.0050e+01
        ]
        lamb = {
            'MAPS': [
                0.0181, 0.0511, 0.0841, 0.1170, 0.1500, 0.1829, 0.2159, 0.2489, 0.2818, 0.3148, 0.3477, 0.3807, 0.4137,
                0.4466, 0.4796, 0.5126, 0.5455, 0.5785, 0.6114, 0.6444, 0.6774, 0.7103, 0.7433, 0.7762, 0.8092, 0.8422,
                0.8751, 0.9081, 0.9411, 0.9740, 1.0070, 1.0399, 1.0729, 1.1059, 1.1388, 1.1718, 1.2047, 1.2377, 1.2707,
                1.3036, 1.3366, 1.3696, 1.4025, 1.4355, 1.4684, 1.5014, 1.5344, 1.5673, 1.6003, 1.6332, 1.6662, 1.6992,
                1.7321, 1.7651, 1.7980, 1.8310, 1.8640, 1.8969, 1.9299, 1.9629, 1.9958, 2.0288, 2.0617, 2.0947, 2.1277,
                2.1606, 2.1936, 2.2266, 2.2595, 2.2925, 2.3254, 2.3584, 2.3914, 2.4243, 2.4573, 2.4902, 2.5232, 2.5562,
                2.5891, 2.6221, 2.6551, 2.6880, 2.7210, 2.7539, 2.7869, 2.8199, 2.8528, 2.8858, 2.9187, 2.9517, 2.9847,
                3.0176, 3.0506, 3.0835, 3.1165, 3.1495, 3.1824, 3.2154, 3.2484, 3.2813, 3.3143, 3.3472, 3.3802, 3.4132,
                3.4461, 3.4791, 3.5120, 3.5450, 3.5780, 3.6109, 3.6439, 3.6769, 3.7098, 3.7428, 3.7757, 3.8087, 3.8417,
                3.8746, 3.9076, 3.9406, 3.9735, 4.0065, 4.0394, 4.0724, 4.1054, 4.1383, 4.1713, 4.2042, 4.2372, 4.2702,
                4.3031, 4.3361, 4.3690, 4.4020, 4.4350, 4.4679, 4.5009, 4.5339, 4.5668, 4.5998, 4.6327, 4.6657, 4.6987,
                4.7316, 4.7646, 4.7976, 4.8305, 4.8635, 4.8964, 4.9294, 4.9624, 4.9953, 5.0283, 5.0612, 5.0942, 5.1272,
                5.1601, 5.1931, 5.2260, 5.2590, 5.2920, 5.3249, 5.3579, 5.3909, 5.4238, 5.4568, 5.4897, 5.5227, 5.5557,
