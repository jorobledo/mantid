...
class CrystalFieldMultiSiteTests(unittest.TestCase):
    ...
    def test_set_background(self):
        cf = CrystalFieldMultiSite(Ions='Ce', Symmetries='C2v', Temperatures=[20], FWHM=[1.0],
                                   Background='name=LinearBackground,A0=1')
    ...
    def test_set_background_with_peak(self):
        ...
        cf = CrystalFieldMultiSite(Ions='Ce', Symmetries='C2v', Temperatures=[20], FWHM=[1.0],
                                   Background='name=LinearBackground', BackgroundPeak=Gaussian(Height=1))
    ...
    def test_set_background_composite(self):
        ...
        self.assertEqual('"name=Gaussian,Height=0,PeakCentre=1,Sigma=0;name=LinearBackground,A0=0,A1=0"',
                         cf['Background'])
    ...
    def test_set_background_composite_as_string(self):
        cf = CrystalFieldMultiSite(Ions='Ce', Symmetries='C2v', Temperatures=[20], FWHM=[1.0],
                                   Background='name=Gaussian,Height=0,PeakCentre=1,Sigma=0;name=LinearBackground,'
                                              'A0=0,A1=0')
        self.assertEqual('"name=Gaussian,Height=0,PeakCentre=1,Sigma=0;name=LinearBackground,A0=0,A1=0"',
                         cf['Background'])
