...
class DirectEnergyConversionTest(unittest.TestCase):
    ...
    def test_set_non_default_complex_value(self):
        ...
        self.assertAlmostEqual(
            range[0], 1000., 7,
            " Default integration min range on MAPS should be as described in MAPS_Parameters.xml file")
        self.assertAlmostEqual(
            range[1], 2000., 7,
            " Default integration max range on MAPS should be as described in MAPS_Parameters.xml file")
    ...
    def test_set_non_default_complex_value_synonims(self):
        ...
        self.assertTrue("ei_mon_spectra" in prop_changed,
    ...
    def test_save_formats(self):
        ...
        tReducer._DirectEnergyConversion__save_formats['.nxspe'] = lambda workspace, filename: f_nxspe(
            workspace, filename)
