...
class ElementalAnalysisContextTest(unittest.TestCase):
    ...
    def test_get_list_of_binned_or_unbinned_workspaces_from_equivalents(self):
        input_list = ["9999; Detector 1" , "9999; Detector 2", "9998; Detector 1",
                      "9998; Detector 2" ]
        ...
        self.add_groups_to_group_context()
        self.context.group_context[input_list[0]].update_workspaces(returned_data[0], True)
        self.context.group_context[input_list[3]].update_workspaces(returned_data[3], True)

        workspaces = self.context.get_list_of_binned_or_unbinned_workspaces_from_equivalents(input_list)
