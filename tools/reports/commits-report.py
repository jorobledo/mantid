...
def parse_commit_data():
    ...
    with open('commits-report.csv', mode='w', newline='') as output_file:
        ...
        commit_writer.writerow([
            "Author", "Email", "Facility", "Date_time", "Year", "Quarter", "Month", "Week", "Commits", "Files Changed",
            "Insertions", "Deletions", "Net Lines Changed"
        ])
    ...
    try:
        ...
        if match.group(3) != "Merge":
            ...
            commit_writer.writerow([
                ...
                date_time.strftime("%Y"), (date_time.month - 1) // 3 + 1,
                date_time.strftime("%m"),
                date_time.isocalendar()[1], 1, files, insertions, deletions, insertions - deletions
            ])
