...
parser = argparse.ArgumentParser(
    description='Extracts code blocks marked as python from mediawiki pages and tests they run.')
parser.add_argument('-i',
                    '--i',
                    help='The title of a mediawiki page, if not specified it will search the Tested Examples category')
parser.add_argument('-s', '--s', help='The url of a mantid mediawiki site')
parser.add_argument('-o', '--o', help='Provide a path to output to an output directory')
